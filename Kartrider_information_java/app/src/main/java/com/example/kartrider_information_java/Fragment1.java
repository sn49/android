...
//        String text = bundle.getString("text");
  //      nickName.setText(text);
        kartView=v.findViewById(R.id.kart_view);
        characterview=v.findViewById(R.id.character_view);
        trackView =v.findViewById(R.id.track_view);
        userview= v.findViewById(R.id.userview);
        button_search=v.findViewById(R.id.button_search);
                    ...
                    while(jsonReader.hasNext()){
                        if(jsonReader.peek().toString().equals("BEGIN_ARRAY")){
                            ...
                            if(name.equals("matchRank")) {
                                ...
                                resourceid = resources.getIdentifier("_"+trackId,"drawable",getActivity().getPackageName());
